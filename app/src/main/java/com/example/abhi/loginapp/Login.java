                    ...
                    new GraphRequest.GraphJSONObjectCallback() {
                        ...
                        public void onCompleted(
                            ...
                            try {
                                ...
                                Toast.makeText(getActivity(), "Hey Bro!! " + object.get("name").toString(), Toast.LENGTH_LONG).show();
    ...
    public void GetGdata(GoogleSignInAccount googleSignInAccount) {
        ...
        try {
            ...
            try {
                ...
                Toast.makeText(getActivity(), "Heyaa " + googleSignInAccount.getDisplayName(), Toast.LENGTH_LONG).show();
